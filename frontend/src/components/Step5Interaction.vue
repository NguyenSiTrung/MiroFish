        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
              ...
              <div class="tools-grid">
                ...
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonomous interviews that conduct parallel multi-round dialogues with simulated individuals, collecting unstructured opinion data and psychological states</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Chat with Report Agent to explore report content' : 'Chat with simulated individuals to understand their perspectives' }}
              </p>
            </div>
            <div 
...
const renderMarkdown = (content) => {
  ...
  // Fix non-consecutive ordered list numbering: keep numbering incrementing across separated ol elements
