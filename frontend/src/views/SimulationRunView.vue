...
// Get maxRounds from query params at init so child components have it immediately
...
const handleGoBack = async () => {
  ...
  try {
    // First try graceful shutdown of simulation env
...
const loadGraph = async (graphId) => {
  // During simulation, auto-refresh without fullscreen loading to avoid flicker
