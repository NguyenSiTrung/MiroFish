            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Enter simulation or prediction requirements in natural language (e.g., What public opinion trends would emerge if University X announced revoking a student's disciplinary action?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
