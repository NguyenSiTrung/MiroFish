...
class ZepEntityReader:
    ...
    def _call_with_retry(
        ...
        Args:
            func: Function to execute (lambda or callable with no params)
    ...
    def get_all_nodes(self, graph_id: str) -> List[Dict[str, Any]]:
        ...
        logger.info(f"Total fetched {len(nodes_data)}  nodes")
        return nodes_data
    ...
    def get_node_edges(self, node_uuid: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.warning(f"Get node {node_uuid}  edge fetch failed: {str(e)}")
            return []
    ...
    def filter_defined_entities(
        ...
        Filter logic:
        - If node Labels only have "Entity", this entity does not match predefined types, skip
        - If node Labels contain labels beyond "Entity" and "Node", it matches predefined types, keep
        ...
        for node in all_nodes:
            ...
            # If predefined types specified, check matching
            ...
            if enrich_with_edges:
                ...
                # Get associated node basic info
                related_nodes = []
        ...
        logger.info(f"Filtering done: total nodes {total_count}, matching {len(filtered_entities)}, "
    ...
    def get_entity_with_context(
        ...
        """
        Get single entity with full context (edges and associated nodes, with retry)
