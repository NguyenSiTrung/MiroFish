...
2. Simulation script polls command directory, executes and writes response to responses/ directory
...
class SimulationIPCClient:
    ...
    def send_command(
        ...
        raise TimeoutError(f"Command response wait timeout ({timeout}seconds)")
