...
class SimulationManager:
    ...
    def prepare_simulation(
        ...
        3. Use LLM to generate simulation config parameters (time, activity level, posting frequency, etc.)
        ...
        try:
            ...
            # Reddit already saves during generation, save again to ensure completeness
            if progress_callback:
                progress_callback(
            ...
            if progress_callback:
                progress_callback(
                    ...
                    "Calling LLM for config generation...",
                    current=1,
                    total=3
                )
            ...
            logger.info(f"Simulation preparation done: {simulation_id}, "
