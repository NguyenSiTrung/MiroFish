...
class AgentActivity:
    ...
    def to_episode_text(self) -> str:
        ...
        Uses natural language format to let Zep extract entities and relationships
        No simulation prefix to avoid misleading graph updates
        """
        ...
        # Returns "agent name: activity description" format, no simulation prefix
    ...
    def _describe_search_user(self) -> str:
        ...
        return f"Searched users "{query}"" if query else "Searched users "
...
class ZepGraphMemoryUpdater:
    ...
    Monitors simulation action logs, updates new agent activities to Zep graph in real-time.
    Groups by platform, sends in batches after accumulating BATCH_SIZE activities.
    ...
    - Username of followed/muted user
    ...
    def __init__(self, graph_id: str, api_key: Optional[str] = None):
        ...
        # Per-platform activity buffer (accumulated to BATCH_SIZE before batch send)
    ...
    def add_activity(self, activity: AgentActivity):
        ...
        action_args contain full context (e.g. original post text, username, etc.).
    ...
    def _worker_loop(self):
        """Background worker loop - send activities to Zep in per-platform batches"""
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "items_sent": self._total_items_sent,        # Successful activity item count
...
class ZepGraphMemoryManager:
    """
    Manages ZepGraph memory updaters for multiple simulations
