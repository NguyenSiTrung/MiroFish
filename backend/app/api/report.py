...
def get_generate_status():
    ...
    try:
        ...
        # If simulation_id provided, check for completed report first
        if simulation_id:
            existing_report = ReportManager.get_report_by_simulation(simulation_id)
            if existing_report and existing_report.status == ReportStatus.COMPLETED:
                return jsonify({
...
def check_report_status(simulation_id: str):
    ...
    try:
        ...
        # Interview is unlocked only after report is complete
...
def get_agent_log(report_id: str):
    ...
    Query params:
        from_line: Start reading from line (optional, default 0, for incremental fetching)
