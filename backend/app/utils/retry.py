...
Retry logic for external API calls (LLM, etc.)
"""
...
class RetryableAPIClient:
    ...
    def call_batch_with_retry(
        ...
        """
        Batch call with individual retry on failures
        
        Args:
            items: List of items to process
            process_func: Processing function, receives single item
            exceptions: Exception types to retry on
            continue_on_failure: Whether to continue after item failure
